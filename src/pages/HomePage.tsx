...
export function HomePage() {
  ...
  // Non-authenticated: parent-focused landing page
      ...
      <div className="min-h-screen bg-gradient-to-b from-cream to-coral-light p-6">
        <div className="max-w-md mx-auto">
          <div className="text-center mb-8 pt-12">
            ...
            <p className="text-xl font-bold text-charcoal-light mt-4">
              Turn daily habits into epic quests for your kids.
            </p>
          </div>

          {/* Value props */}
          <div className="space-y-3 mb-8">
            <div className="flex items-center gap-3 bg-white/80 rounded-2xl p-4 border-2 border-charcoal/10">
              <span className="text-3xl">🗡️</span>
              <p className="font-bold text-charcoal">Chores become quests your kids actually want to do</p>
            </div>
            <div className="flex items-center gap-3 bg-white/80 rounded-2xl p-4 border-2 border-charcoal/10">
              <span className="text-3xl">⭐</span>
              <p className="font-bold text-charcoal">They earn stars and redeem rewards you set</p>
            </div>
            <div className="flex items-center gap-3 bg-white/80 rounded-2xl p-4 border-2 border-charcoal/10">
              <span className="text-3xl">🤖</span>
              <p className="font-bold text-charcoal">AI suggests age-appropriate habits in seconds</p>
            </div>
          </div>
          ...
          <div className="space-y-3 text-center">
            <Button
              size="lg"
              className="w-full text-lg bg-lavender hover:bg-lavender-light font-black py-6"
            ...
            <Button
              variant="outline"
              className="w-full bg-card font-bold"
          ...
          <p className="text-center text-sm font-bold text-charcoal-light mt-8">
            Set up your family's quest HQ in under 3 minutes ✨
          </p>
        </div>
      </div>
    )
  ...
  // Authenticated: kid selector view
  return (
    <div className="min-h-screen bg-gradient-to-b from-cream to-coral-light p-6">
      <div className="max-w-md mx-auto">
        {/* Header */}
        ...
        {/* Fun footer */}
        <p className="text-center text-sm font-bold text-charcoal-light mt-8">
          Complete your quests and earn stars! ✨
        </p>
      </div>
    </div>
  )
